                ...
                mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        ...
                        if (location == null) {
                            ...
                            lat=latitude;
                            lon=longitude;
                            locations=latLng.toString();
                            System.out.println("current location is ==> "+latLng +"  lat ==>"+latitude+"&&   lon ===>"+longitude);
                            ...
                            googleMap.addPolygon(new PolygonOptions().add(latLng));
...
Log.v("voted ==>",vote.toString());
        dataStore(editText.getText().toString(),editText2.getText().toString(),vote,team,name,lon,lat,locations);
...
Handler handler;
    ...
    private void dataStore(String title,String body,Status status,String id,String fileName,double lon,double lat,String loc){
